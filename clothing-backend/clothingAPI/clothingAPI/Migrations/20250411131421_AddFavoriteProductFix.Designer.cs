...
namespace clothingAPI.Migrations
{
    ...
    [Migration("20250411131421_AddFavoriteProductFix")]
    partial class AddFavoriteProductFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ColorProductVariant", b =>
                {
                    b.HasOne("clothingAPI.Models.Color", null)
                        .WithMany()
                        .HasForeignKey("ColorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("clothingAPI.Models.ProductVariant", null)
                        .WithMany()
